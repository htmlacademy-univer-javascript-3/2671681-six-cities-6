...
import ReviewItemRating from './review-item-rating';
import { MAX_RATING } from '../../const';

describe('Component: ReviewItemRating', () => {
  it('should render correctly with rating', () => {
    const rating = 4;
    render(<ReviewItemRating rating={rating} />);
  ...
  it('should calculate width correctly for rating 2', () => {
    const rating = 2;
    render(<ReviewItemRating rating={rating} />);
